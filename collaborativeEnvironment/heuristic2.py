...
####################################################
#      AGENT HEURISTIC 2                           #
#      GOES TO THE CLOSEST BOX FROM IT'S LEVEL     #
####################################################
...
class HeuristicAgent2():
    ...
    def get_action(self, observations):
        ...
        if otherAction is not None:
            ...
            next_pos = self.action_to_closest_box_from_its_level()

        selected_action = Action.NOOP
        #print("next pos for {}: {}".format(self.agentNumber, next_pos))
    ...
    def action_to_closest_box_from_its_level(self):
        from_its_level = 0
        for shelf in self.shelves:
            if shelf[2] == self.agent_level:
                from_its_level += 1
